...
We always recommend the xref::enterprise-analytics-sdk-release-notes.adoc#latest-release[latest version] of the SDK. 
This not only contains the latest security updates and bug fixes, but will be compatible with the latest Enterprise Analytics release -- Capella Analytics always runs a recent version of Enterprise Analytics.
